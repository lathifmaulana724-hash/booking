...
if (isset($_POST['edit'])) {
    ...
    if ($waktu_awal_timestamp < $waktu_akhir_timestamp) {
        $res = mysqli_query($conn, "UPDATE pesanan 
            SET
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row card border p-5">
                        ...
                        <div class="d-flex justify-content-center">
                            <h1 class="px-5 mt-3">Edit Pesanan Lapangan Futsal</h1>
                        </div>
                        <br>
                        <form action="" method="POST">
                            <input value="<?= $pesanan['nama_pelanggan']; ?>" name="nama_pelanggan" type="text" placeholder="Nama Pelanggan" class="form-control mb-4">
                            <small class="text-dark">Tanggal</small>
                            <input value="<?= $pesanan['tanggal']; ?>" name="tanggal" type="date" placeholder="Tanggal" class="form-control mb-4">
                            <small class="text-dark">Waktu Mulai</small>
                            <input value="<?= $pesanan['waktu_awal']; ?>" name="waktu_awal" type="time" placeholder="Waktu Awal" class="form-control mb-4">
                            <small class="text-dark">Waktu Akhir</small>
                            <input value="<?= $pesanan['waktu_akhir']; ?>" name="waktu_akhir" type="time" placeholder="Waktu Akhir" class="form-control mb-4">
                            <input value="<?= $pesanan['nominal']; ?>" name="nominal" type="number" placeholder="Nominal" class="form-control mb-4">
                            <center>
